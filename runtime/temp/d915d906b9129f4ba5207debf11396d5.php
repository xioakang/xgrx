<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"E:\waibao\xgrx\public/../application/admin\view\artile\edit.html";i:1607678590;s:57:"E:\waibao\xgrx\application\admin\view\layout\default.html";i:1602168705;s:54:"E:\waibao\xgrx\application\admin\view\common\meta.html";i:1602168705;s:56:"E:\waibao\xgrx\application\admin\view\common\script.html";i:1602168705;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-artile_category_id" data-rule="required" data-source="artile_category/index" class="form-control selectpage" name="row[artile_category_id]" type="text" value="<?php echo htmlentities($row['artile_category_id']); ?>" data-field="category_name" >
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-fabulous" data-rule="required" class="form-control" name="row[fabulous]" type="number" value="<?php echo htmlentities($row['fabulous']); ?>">
        </div>
    </div>
    <div class="form-group">
