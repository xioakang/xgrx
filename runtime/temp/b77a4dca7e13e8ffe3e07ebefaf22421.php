<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"E:\waibao\xgrx\public/../application/admin\view\information\add.html";i:1607482198;s:57:"E:\waibao\xgrx\application\admin\view\layout\default.html";i:1602168705;s:54:"E:\waibao\xgrx\application\admin\view\common\meta.html";i:1602168705;s:56:"E:\waibao\xgrx\application\admin\view\common\script.html";i:1602168705;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-category_id" data-rule="required" data-source="category/selectpage" data-params='{"custom[type]":"information", "custom[pid]":"0"}' class="form-control selectpage" name="row[category_id]" type="text" value="" onchange="set_next_input_category(this);">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Subcategory_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-subcategory_id" data-rule="required"   class="form-control selectpage" name="row[subcategory_id]" type="text" value="" >
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-prescription" class="form-control" name="row[prescription]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Contacts_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-contacts_name" data-rule="required" class="form-control" name="row[contacts_name]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Contacts_phone'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-contacts_phone" data-rule="required;mobile" class="form-control" name="row[contacts_phone]" type="text" value="" >
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Contacts_qq'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-contacts_qq" class="form-control" name="row[contacts_qq]" type="text" value="" data-rule="qq">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Detailed_address'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-detailed_address" data-rule="required" class="form-control" name="row[detailed_address]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-update_password" class="form-control" name="row[update_password]" type="text" value="">
        </div>
    </div>
